...
@font-face {
  ...
  src: url('https://cdn.jsdelivr.net/gh/lazywasabi/thai-web-fonts@2/fonts/NotoSansThai/NotoSansThai-Regular.woff2')
    format('woff2');
  font-style: normal;
  font-weight: normal;
  font-display: swap;
...
@font-face {
  font-family: 'Noto Sans Thai';
  src: url('https://cdn.jsdelivr.net/gh/lazywasabi/thai-web-fonts@2/fonts/NotoSansThai/NotoSansThai-Bold.woff2')
    format('woff2');
  font-style: normal;
  font-weight: bold;
  font-display: swap;

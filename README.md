...
- ดูข้อมูลและวิธีใช้งาน ตัวอย่างฟอนต์ และ CSS พร้อมใช้ได้บนเว็บไซต์ [**thaiwebfonts.pages.dev**](https://thaiwebfonts.pages.dev)
...
ผมไม่แนะนำให้ลบเลขเวอร์ชันออกจาก URL หรือใช้ `@latest` เพราะในกรณีที่มีการเปลี่ยนแปลงรูปแบบไฟล์ URL เดิมจะยังคงสามารถใช้งานได้ตามปกติ โดยสามารถตัดเลขเวอร์ชัน 2 หลักท้ายออก และใช้เลขเวอร์ชันหลักแรกอย่างเดียวได้ตามตัวอย่างด้านบน
